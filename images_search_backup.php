...
<?php
 if ($_SESSION['username'] == 'admin'){
  $sql = "select * from applicants where  application_status='FINISHED' and (payment_exempted=1 or payment_status='SUCCESS') and is_final=1 and  transactionid='".$_POST['regid']."'  limit 1"; 
 }else {
...
?>
		...
		<form method="post" id="form">
				...
				from applicants RD where application_status='FINISHED'  and (payment_exempted=1 or payment_status='SUCCESS') and is_final=1  ");
				}else {
				...
				from personal_details RD, emp_details A  Where RD.pf_nps_no=A.pf_nps_no and  and is_final=1 and A.division='".$_SESSION['username']."' ");	
				}
				...
				?>
						...
						<td> <input type="radio" required name="name_mimacth"  id="name_mimacth"  value="Yes"><label for="name_mimacth"><b>Yes</b></label><span style="font-size:16px">|</span>
						...
						<td> <input type="radio" required name="gender_mimacth"  id="gender_mimacth"  value="Yes"><label for="gender_mimacth"><b>Yes</b></label><span style="font-size:16px">|</span>
						...
						<td> <input type="radio" required name="father_mimacth"  id="father_mimacth"  value="Yes"><label for="father_mimacth"><b>Yes</b></label><span style="font-size:16px">|</span>
						...
						<td> <input type="radio" required name="cat_mismatch"  id="cat_mismatch"  value="Yes"><label for="cat_mismatch"><b>Yes</b></label><span style="font-size:16px">|</span>
						...
						<td> <input type="radio" required name="dob_mimacth"  id="dob_mimacth"  value="Yes"><label for="dob_mimacth"><b>Yes</b></label><span style="font-size:16px">|</span>
						...
						<td> <input type="radio" required name="pwd_mimacth"  id="pwd_mimacth"  value="Yes"><label for="pwd_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
						...
						<td>
						Exman </td> <td> Yes</td>
						<td> <input type="radio" required name="exman_mimacth"  id="exman_mimacth"  value="Yes"><label for="exman_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
						...
						<td> <input type="radio" required name="iti_mimacth"  id="iti_mimacth"  value="Yes"><label for="iti_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
						<input type="radio" name="iti_mimacth"  id="iti_mimacth1"  value="No"><label for="iti_mimacth1"><b>No</b></label>	</td>
						</tr>
						<tr>
						<td colspan='2'>
						WHETHER PRODUCED COPY OF ONLINE APPLICATION/REGISTRATION FORM 
						</td>						
						...
						<td> <input type="radio" required name="10dob_mimacth"  id="10dob_mimacth"  value="Yes"><label for="10dob_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
						...
						<td> <input type="radio" required name="scvt_ncvt_mimacth"  id="scvt_ncvt_mimacth"  value="Yes"><label for="scvt_ncvt_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
						...
						<td> <input type="radio" required name="iti_sem_mimacth"  id="iti_sem_mimacth"  value="Yes"><label for="iti_sem_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
						...
						<td> <input type="radio" required name="fee_mimacth"  id="fee_mimacth"  value="Yes"><label for="fee_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
...
SC/ST/OBC/EWS)
                       ...
                       <?php   if($row['community'] !== 'General')	{ ?>					
						<td> <input type="radio" required name="cast_mimacth"  id="cast_mimacth"  value="Yes"><label for="cast_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
						<input type="radio" name="cast_mimacth"  id="cast_mimacth1"  value="No"><label for="cast_mimacth1"><b>No</b></label>	</td>
						<?php } else { ?>
						<td> NA<input type="hidden" required name="cast_mimacth"  id="cast_mimacth"  value="NA"></td>
						<?php } ?>
						</tr>
						...
						<td> <input type="radio" required name="pwdc_mimacth"  id="pwdc_mimacth"  value="Yes"><label for="pwdc_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
						<input type="radio" name="pwdc_mimacth"  id="pwdc_mimacth1"  value="No"><label for="pwdc_mimacth1"><b>No</b></label>	</td>						
						<?php } else { ?>
						<td> NA<input type="hidden" required name="pwdc_mimacth"  id="pwdc_mimacth"  value="NA"></td>
						<?php } ?>
						<td colspan='2'>
						...
						?>						
						<td> <input type="radio" required name="esmc_mimacth"  id="esmc_mimacth"  value="Yes"><label for="esmc_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
						<input type="radio" name="esmc_mimacth"  id="esmc_mimacth1"  value="No"><label for="esmc_mimacth1"><b>No</b></label>	</td>
						<?php } else { ?>
						<td> NA<input type="hidden" required name="esmc_mimacth"  id="esmc_mimacth"  value="NA"></td>
						<?php } ?>
						</tr>
						...
						?>						
						<td> <input type="radio" required name="exch_mimacth"  id="exch_mimacth"  value="Yes"><label for="exch_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
						<input type="radio" name="exch_mimacth"  id="exch_mimacth1"  value="No"><label for="exch_mimacth1"><b>No</b></label>	</td>						
						<?php } else { ?>
						<td> NA<input type="hidden" required name="exch_mimacth"  id="exch_mimacth"  value="NA"></td>
						<?php } ?>
						<td colspan='2'>
						WHETHER PRODUCED 12TH CLASS CERTIFICATE IF APPLICABLE

						</td>						
						<td> <input type="radio" required name="twelth_mimacth"  id="twelth_mimacth"  value="Yes"><label for="twelth_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
						<input type="radio" name="twelth_mimacth"  id="twelth_mimacth1"  value="No"><label for="twelth_mimacth1"><b>No</b></label>	</td>
						...
						<td> <input type="radio" required name="act_mimacth"  id="act_mimacth"  value="Yes"><label for="act_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
						...
						<td> <input type="radio" required name="medical_mimacth"  id="medical_mimacth"  value="Yes"><label for="medical_mimacth"><b>Yes</b></label> <span style="font-size:16px">|</span>
              ...
              <h1><a target='_blank' href='acknowledgement.php?regid=<?php echo $row['transactionid']; ?>'>Click here to Online Acknowlegement</a></h1>
