...
<?php
 if ($_SESSION['username'] == 'admin'){
   $sql ="select transactionid,fullname,father_name,mother_name,concat(village,',',tehsil,',',postoffice,',',policestation) as peraddress,
...
c.regid=a.transactionid  where a.transactionid=e.RegistrationID and is_final=1 and is_certificate_status is not null and  a.transactionid='".$_POST['regid']."'     limit 1"; 
 }else {
				...
				?>
						...
						<table style='margin: 10px 100px;' class="table table-bordered">
							...
							<tr>
								...
								<td style="width:15% !important"> <?php echo $row['name_mismatch'] ?>	</td>
							</tr>
						<tr>
